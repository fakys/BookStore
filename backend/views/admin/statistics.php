...
foreach ($clients as $val){
    ...
    if($client_issued&&$client_issued->asArray()->one()){
    ...
    <div class="d-flex flex-column justify-content-center gap-5">
        <div class="d-flex justify-content-center align-items-center flex-column">
            <div class="col-6 col-md-3 text-center ">
                <input type="text" class="knob" value="<?=$percent_with_books?>" data-width="200" data-height="200" data-fgColor="#3c8dbc"
                       data-readonly="true">
        ...
        <div class="d-flex flex-column align-items-center">
            <div class="col-6 col-md-3 text-center">
                <input type="text" class="knob" value="<?=$percent_without_books?>" data-width="200" data-height="200" data-fgColor="#f56954"
                       data-readonly="true">
